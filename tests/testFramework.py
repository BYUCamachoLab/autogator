...
class Test:
    def __init__(
        ...
        trigger_channel=1,
        trigger_level=1,
        scope_IP="10.32.112.162",
        scope_protocol="INSTR",
        scope_range_1=10,
        scope_range_2=5,
        scope_range_3=5,
        scope_range_4=5,
        ...
        scope_position_2=-4,
        scope_position_3=-2,
        scope_position_4=0.5,
        circuits_text_file="circuits.txt",
    ):
        ...
        self.append_date = (
            append_date  # Appends date to the beginning of the directory.
        )
        ...
        self.trigger_level = (
            trigger_level  # Voltage threshold for postitive slope edge trigger.
        )
    ...
    def run(self):
        ...
        print(
            "Setting trigger to: {} and step to {}".format(
                triggerMode, self.triggerStep
            )
        )
        ...
        rawData[1:] = [
            scope.get_data_ascii(channel) for channel in self.active_channels
        ]
