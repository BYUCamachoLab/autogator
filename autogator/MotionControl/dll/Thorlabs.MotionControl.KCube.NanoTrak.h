...
extern "C"
{
	...
	typedef enum KNA_FeedbackSource : WORD
	{
		...
		NT_SMA_5v = 0x04, ///< The  SMA input source at 5V.
	} KNA_FeedbackSource;
	...
	{
		KNA_SMAOnly = 0x0001 ///<Output to SMA connector only.
	};
	...
	enum KNA_HighOutputVoltageRoute : WORD
	{
		...
		KNA_ExtIn_SMA = 0x0001,///<Input via SMA
		KNA_ExtOut_Dis = 0x0000,///<Output Disabled
		KNA_ExtOut_SMA = 0x0010,///<Output via SMA
	...
	typedef enum KNA_JoyStickChangeRate : __int16
	{
	...
	typedef struct KNA_MMIParams
	{
		...
		KNA_JoyStickChangeRate JoystickAdjustRate;
...
#pragma pack()
	...
	/// <param name="serialNo"> The device serial no. </param>
	/// <param name="joystickAdjustRate">  The joystickmove at voltage rate.
	/// 					<list type=table>
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="NT_SetMMIParams(char const * serialNo, KNA_JoyStickChangeRate voltageAdjustRate, __int16 displayIntensity)" />
	...
	NANOTRAK_API  short __cdecl NT_GetMMIParams(char const * serialNo, KNA_JoyStickChangeRate *joystickAdjustRate, __int16 *displayIntensity);
	...
	/// <param name="displayIntensity">	    The display intensity, range 0 to 100%. </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="NT_GetMMIParamsExt(char const * serialNo, KNA_JoyStickMode *joystickMode, KNA_JoyStickChangeRate *voltageAdjustRate, __int32 *voltageStep, KNA_JoystickDirectionSense *directionSense, __int32 *presetVoltage1, __int32 *presetVoltage2, __int16 *displayIntensity)" />
	/// <seealso cref="NT_SetMMIParamsBlock(const char * serialNo, KNA_MMIParams *mmiParams)" />
	/// <seealso cref="NT_GetMMIParamsBlock(const char * serialNo, KNA_MMIParams *mmiParams)" />
	NANOTRAK_API short __cdecl NT_SetMMIParams(char const * serialNo, KNA_JoyStickChangeRate joystickAdjustRate, __int16 displayIntensity);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="NT_GetMMIParamsExt(char const * serialNo, KNA_JoyStickMode *joystickMode, KNA_JoyStickChangeRate *voltageAdjustRate, __int32 *voltageStep, KNA_JoystickDirectionSense *directionSense, __int32 *presetVoltage1, __int32 *presetVoltage2, __int16 *displayIntensity, __int16 *displayTimeout, __int16 *displayDimIntensity)" />
	/// <seealso cref="NT_SetMMIParamsExt(char const * serialNo, KNA_JoyStickMode joystickMode, KNA_JoyStickChangeRate voltageAdjustRate, __int32 voltageStep, KNA_JoystickDirectionSense directionSense, __int32 presetVoltage1, __int32 presetVoltage2, __int16 displayIntensity, __int16 displayTimeout, __int16 displayDimIntensity)" />
	/// <seealso cref="NT_SetMMIParamsBlock(const char * serialNo, KNA_MMIParams *mmiParams)" />
