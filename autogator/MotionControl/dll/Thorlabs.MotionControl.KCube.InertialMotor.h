...
#pragma pack(1)
	...
	struct KIM_TrigIOConfig
	{
		...
		__int16 _trigChannel1;
		/// <summary>	The second trig channel. </summary>
		__int16 _trigChannel2;
...
#pragma pack()
	...
	/// <seealso cref="KIM_SetTrigIOParameters(char const * serialNo, KIM_TrigModes trig1Mode, KIM_TrigPolarities trig1Polarity, __int16 trigChannel1, KIM_TrigModes trig2Mode, KIM_TrigPolarities trig2Polarity, __int16 trigChannel2)" />
	...
	KCUBEINERTIALMOTOR_API short __cdecl KIM_GetTrigIOParameters(char const * serialNo, KIM_TrigModes & trig1Mode, KIM_TrigPolarities & trig1Polarity, __int16 & trigChannel1, KIM_TrigModes & trig2Mode, KIM_TrigPolarities & trig2Polarity, __int16 & trigChannel2);
	...
	/// <seealso cref="KIM_GetTrigIOParametersStruct(char const * serialNo, KIM_TrigIOConfig& trigIOParameters)" />
	/// <seealso cref="KIM_SetTrigIOParametersStruct(char const * serialNo, KIM_TrigIOConfig& trigIOParameters)" />
	KCUBEINERTIALMOTOR_API short __cdecl KIM_SetTrigIOParameters(char const * serialNo, KIM_TrigModes trig1Mode, KIM_TrigPolarities trig1Polarity, __int16 trigChannel1, KIM_TrigModes trig2Mode, KIM_TrigPolarities trig2Polarity, __int16 trigChannel2);
